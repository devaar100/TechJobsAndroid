package aarnav100.developer.techjobs.TagView;

import android.graphics.drawable.Drawable;
import aarnav100.developer.techjobs.TagView.tagview.Constants;
...
public class Tag {
    ...
    public Tag(String text) {
        init(0, text, aarnav100.developer.techjobs.TagView.tagview.Constants.DEFAULT_TAG_TEXT_COLOR, Constants.DEFAULT_TAG_TEXT_SIZE, Constants.DEFAULT_TAG_LAYOUT_COLOR, Constants.DEFAULT_TAG_LAYOUT_COLOR_PRESS,
